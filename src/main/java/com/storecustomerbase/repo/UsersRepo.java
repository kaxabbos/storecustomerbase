...
public interface UsersRepo extends JpaRepository<Users, Long> {
    ...
    List<Users> findAllByRoleAndPrimarys_SurnameContainingAndTertiary_MaritalAndTertiary_OriginAndTertiary_CitizenshipAndTertiary_RetireeAndTertiary_ConscriptedAndTertiary_Disability(Role role, String surname, Marital marital, Origin origin, Citizenship citizenship, YesNo retiree, YesNo conscripted, Disability disability);
