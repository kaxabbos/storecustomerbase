...
import com.storecustomerbase.model.*;
...
public class HumansCont extends Attributes {
    ...
    public String HumanNoteAdd(@PathVariable Long id, @RequestParam String text) {
        notesRepo.save(new Notes(text, DateNow(), getUser(), usersRepo.getReferenceById(id)));
